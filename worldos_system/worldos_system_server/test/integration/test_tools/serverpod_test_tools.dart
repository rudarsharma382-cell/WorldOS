...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    investigation = _InvestigationEndpoint(
      endpoints,
      serializationManager,
    );
...
class _AiEndpoint {
  ...
  _i3.Future<String> generateBriefing(
    _i1.TestSessionBuilder sessionBuilder,
    double lat,
    double lon,
    double radiusKm,
...
class _EventEndpoint {
  ...
  _i3.Future<List<_i5.WorldEvent>> getActiveEvents(
    _i1.TestSessionBuilder sessionBuilder,
    String? typeFilter,
    String? searchQuery,
    int limit,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i5.WorldEvent>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i5.WorldEvent>> getEventsNearLocation(
    _i1.TestSessionBuilder sessionBuilder,
    double lat,
    double lon,
    double radiusKm,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'event',
            method: 'getEventsNearLocation',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'event',
          methodName: 'getEventsNearLocation',
          parameters: _i1.testObjectToJson({
            'lat': lat,
            'lon': lon,
            'radiusKm': radiusKm,
  ...
  _i3.Future<_i5.WorldEvent> saveAndBroadcastEvent(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.WorldEvent event,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'event',
            method: 'saveAndBroadcastEvent',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'event',
          methodName: 'saveAndBroadcastEvent',
...
class _InvestigationEndpoint {
  _InvestigationEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<_i6.Investigation> createInvestigation(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'investigation',
          methodName: 'createInvestigation',
          parameters: _i1.testObjectToJson({'investigation': investigation}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.Investigation>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i6.Investigation>> getInvestigations(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.Investigation>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i8.WatchZone> createWatchZone(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'watchZone',
            method: 'createWatchZone',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'watchZone',
          methodName: 'createWatchZone',
          parameters: _i1.testObjectToJson({'watchZone': watchZone}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i8.WatchZone>> getWatchZones(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'watchZone',
            method: 'getWatchZones',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'watchZone',
          methodName: 'getWatchZones',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
